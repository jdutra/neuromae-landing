  ...
  useEffect(() => {
    ...
    const hShowCTA = (cta: NonNullable<ConvNode["cta"]>) => {
      ...
      card.innerHTML = `
        ...
        <div class="h-cta-meta"><strong>R$ 79,90/mês</strong> depois dos 7 dias · cancele por mensagem</div>
          ...
          <div className="section-head">
            ...
            <div className="anchor">
              ...
              <div className="anchor-row featured">
                ...
                <span className="anchor-price"><strong>R$ 79,90</strong> / mês</span>
              </div>
            </div>
      ...
      <section className="section" id="faq">
        <div className="wrap">
          ...
          <div className="faq-list">
            ...
            <details>
              <summary>Por que pagar R$79,90/mês se posso usar uma IA generalista?</summary>
              <div className="answer-faq">
